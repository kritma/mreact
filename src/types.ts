...
export type MessageData = {
    ...
    is_send_by_user: boolean, text: string, created_at: Date,
    images: string[], music: string[], videos: string[], files: string[]
}
export type UserData = { id: number, name: string, image_url: string }
export type PostData = { id: number, description: string, created_at: number, user: UserData, images: string[], music: string[], videos: string[], files: string[] }
